...
See [Career-point cap](./lockgm-career-point-cap.md) for the long-term commitment pool (distinct from Classic Matchup’s annual salary hard cap): sport base = avg career years × roster size, then **±4%** next year for make/miss playoffs; contracts/dead money stick. Age/star risk: a productive older star may get a **5-point** deal, but mid-deal retirement/exit leaves the club eating the remaining balance as dead money (no escape hatch).
