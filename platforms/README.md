...
Drop the watch script onto an existing Manus/GitHub, Vercel/GitHub, WordPress, Magento, Shopify, or generic HTML site.
...
| Platform | File |
| --- | --- |
| Manus / GitHub | `manus/cinch-seed-watch.html` |
| Vercel / GitHub | `vercel/cinch-seed-watch.html` |
