...
export default function LockgmOfficePage() {
  return (
    <main className="mx-auto w-full max-w-6xl px-6 py-12 sm:px-8">
      ...
      <p className="mt-4 max-w-2xl text-base leading-relaxed text-[color:var(--lg-mute)]">
        Franchise mode, roster needs, assets, and a decision log — switch sports
        in the bar above to sit in a different front office.
      </p>
      <div className="mt-10">
        <GmOffice />
      </div>
