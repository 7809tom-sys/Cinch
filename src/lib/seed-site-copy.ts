...
.seed-run-party-open img,
.seed-run-party-card img {
  width: 2.25rem;
  height: 2.25rem;
  border-radius: 0.35rem;
  object-fit: cover;
...
.seed-run-party-open strong,
.seed-run-party-open small {
  display: block;
  line-height: 1.2;
}
...
.seed-run-party-card {
  ...
  border-radius: 0.5rem;
  background: #fff;
  box-shadow: 0 8px 24px rgba(11, 16, 20, 0.12);
}
